...
- Mason ensures common formatters/linters such as eslint_d, prettierd, biome, black, and isort are available.
...
2. Run `:Mason` and check that `tsserver`, `pyright`, and formatters are installed. Press `i` inside Mason to install any missing tool.
